...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const cozyQuotes = [
    ...
    "就算外面下著雨，你心裡也有個暖洋洋的太陽喔 ☀️",
    "悄悄告訴你，今天全宇宙最棒的就是你啦 💫",
    "閉上眼睛，深呼吸——把所有的不開心都吐出去吧 🌬️",
    "喵～今天也是為你狂奔、帶來越多幸運的一天喔 🐾",
    "伸個大大的懶腰，像貓咪一樣放鬆一下吧 🧘‍♀️🐾",
    "生活就像剛烤好的麵包，軟綿綿又香噴噴的 🍞✨",
    "不管今天有多忙，都要記得對自己溫柔一點唷 🍯",
    "你笑起來的樣子，就像晴天裡最溫暖的微風 🌸",
    "好運正在排隊敲你的門呢，快準備好迎接它吧 🚪🎉",
    "偷偷把今天的煩惱藏在貓砂盆裡，通通埋起來！💩🐾",
    "只要有你在，空氣裡好像都甜甜的呢 🍬🍬",
    "今天的小貓呼嚕聲，是特別送給你的專屬安眠曲 🎵🐱",
    "抱著溫暖的毯子，今晚要做一個甜甜的夢喔 🛌⭐",
    "聽說轉身的那一刻，就會跟生活的美好撞個滿懷唷 🎈🐾",
    "把心裡的電池充滿電，我們一起出發吧 🔋✨"
  ];
